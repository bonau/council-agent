...
- [ ] 1.1 Add required integer schema version 1, strict known-field validation, sanitized diagnostics, and explicit unversioned/unsupported migration refusal in the pure policy loader.
- [ ] 1.2 Add policy unit tests for valid version 1, missing/unsupported/wrong-typed versions, unknown fields, misspellings, invalid known fields, secret-value omission, and whole-file refusal.
- [ ] 1.3 Add restrict-only unit tests proving allow patterns cannot bypass built-in command rejection, confirmation, command deny precedence, or default path denials.
