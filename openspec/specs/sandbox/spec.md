...
Workspace boundary enforcement for tool operations. Introduced in v0.3 via `WorkspaceGuard`, restricting file and shell operations to a configurable workspace root with sensitive path denylist.
