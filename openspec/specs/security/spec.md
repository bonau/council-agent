...
Command classification, interactive confirmation gates, and structured audit logging for shell and filesystem tools. Introduced in v0.6 (classification), v0.7 (confirmation), and v0.8 (audit); later milestones add policy files and trust tiers.
